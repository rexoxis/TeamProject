...
<%
    ArrayList<DogBoard> dblists = (ArrayList)session.getAttribute("dblists");
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="row" style="margin: 10px 30px 20px 50px">
            ...
            <form class="card card-body bg-light" name="rbfrm" action="procDogModify.jsp?bdno=<%=a.getBdno()%>" method="post" enctype="multipart/form-data">
...
<script>
    ...
    $(function () {
        $('#listbtn').on('click', function (e) {
            location.href = '/ttpro/dogboard/dogList.jsp?cpage=1';
        });
    });
    // 상단 로그아웃 버튼
    $(function () {
