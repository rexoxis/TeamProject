...
<body>
    ...
    <div class="main">
            ...
            <form name="frmJoin" action="signcheck1.jsp"  onSubmit="return CheckForm(this)">
                <div class="card card-body bg-light" style="margin: 70px 30px 0 50px">
                    <h4>이용약관</h4>

                    <textarea wrap="hard" rows="10" class="form-control">
        전자상거래(인터넷사이버몰) 표준약관
        ...
        ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다. </textarea>
                    ...
                    <div class="custom-cuntrol custom-checkbox text-right">
                        <input type="checkbox" class="custom-control-input" id="agree1">
                        <label for="agree1" class="custom-control-label" style="margin-top: 20px">이용약관에 동의합니다</label>
                    </div>
                    ...
                    ② "홈페이지"와 이용자간에 제기된 전자거래 소송에는 한국법을 적용합니다. </textarea>

                     <div class="custom-cuntrol custom-checkbox text-right">
                        <input type="checkbox" class="custom-control-input" id="agree2">
                        <label for="agree2" class="custom-control-label" style="margin-top: 20px">개인정보 수집 및 이용에 동의합니다</label>
                     </div>
                </div>
                <div class="text-center" style="margin: 15px 0">
                    <button class="btn btn-success" type="submit" id="agreebtn">모두 동의합니다. </button>
                    <button class="btn btn-danger" type="button" id="notagree" onclick="javascript:history.back();">동의하지 않습니다. </button>
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    function CheckForm(){
        ...
        if(!chk1){                                           // 이용약관에 체크를 안했으면
            alert('이용약관에 동의해 주세요.');                // 얼럿창을 띄움
            return false;
        }
        if(!chk2) {                                         // 개인정보 수집 및 이용에 체크를 안했으면
            alert('개인정보 수집 및 이용에 동의해 주세요.');    // 얼럿창을 띄움
            return false;
        }
        if (chk1 && chk2) {                                 // 모두 체크했을시
            location.href="signcheck1.jsp";                 // signcheck1.jsp 로 이동
        }
    }
</script>