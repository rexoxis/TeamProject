...
//    ArrayList<ReviewBoard> rblists = rbdao.boardList(searchList);
    ...
    ArrayList<ReviewBoard> rblists = rbdao.boardList(searchList, startnum, endnum);
...
<div class="container">
    ...
    <div class="main">
        ...
        <%--검색창--%>
        <form name="revlist" method="post" action="revList.jsp?cpage=1">
            <div align="center">
                <table>
                    <tr>
            ...
            <div class="col-12">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        <% } else { %>
                                <li class="page-item"><a class="page-link" href="revList.jsp?cpage=<%=i%>"><%=i%></a></li>
                            <% } %>
                        <% } %>

                       <% if(endPage <= totalPage) { %>
                        <li class="page-item">
                            <a class="page-link" href="revList.jsp?cpage=<%=(endPage+1)%>" aria-label="Next">
