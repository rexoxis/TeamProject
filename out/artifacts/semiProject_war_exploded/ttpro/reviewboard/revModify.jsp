...
<%
    ArrayList<ReviewBoard> rblists = (ArrayList)session.getAttribute("rblists");
%>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="row" style="margin: 10px 30px 20px 50px">
            ...
            <form class="card card-body bg-light" name="rbfrm" action="procRevModify.jsp?bdno=<%=a.getBdno()%>" method="post" enctype="multipart/form-data">
