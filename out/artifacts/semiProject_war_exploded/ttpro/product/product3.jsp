...
<head>
    ...
    <link rel="stylesheet" href="//static.dogpre.com/skin_web/dogpre/president/css/dog.css?v=20200108121036" />
    <link type="text/css" href="/shop/css/nanoscroller.css?v=20200108121036" rel="stylesheet" />

    <link rel="apple-touch-icon" sizes="180x180" href="//img.dogpre.com/web/dogpre/favicon/apple-touch-icon.png">
    <link rel="shortcut icon" href="//img.dogpre.com/web/dogpre/favicon/favicon.ico?1578453036">
    <link rel="shortcut icon" href="//img.dogpre.com/web/dogpre/favicon/favicon-32x32.ico?1578453036" sizes="32x32">
    <link rel="shortcut icon" href="//img.dogpre.com/web/dogpre/favicon/favicon-16x16.ico?1578453036" sizes="16x16">
...
<main role="main" class="goodsDetailInfo">
...
<div class="centr-box">
    ...
    <!-- 2017-11-14 다니엘 -->
    <div class="big-img"><img src="http://img.dogpre.com/web/dogpre/product/46/45932_detail_01291889.jpg" id="detail_image" width="470" height="470" alt="대표이미지" onerror="this.src='/shop/skin/president/img/common/noimg_500.gif'" /></div>
...
<form name="frmView" method="post">
    <input type="hidden" name="goodsno" id="goodsno" value="45932" />
    <input type="hidden" name="price" value="5000" />
    <input type="hidden" name="supply" value="2500" />
    <input type="hidden" name="consumer" value="5000" />
    <input type="hidden" name="is_sess" id="is_sess" value="0" />
    <input type="hidden" name="event_sno" value="37874" />
    <input type="hidden" name="frmView_goodsno" id="frmView_goodsno" value="45932" />
    <input type="hidden" name="option_sno" value="" />
    <fieldset>
        <legend class="screen-out">상품 상세 구매</legend>
        <div class="mask"></div>
        <div class="hd">
            <h2 class="tit-shop-view">K9 내츄럴 도그 치킨 피스트 캔 170g<span class="add-goods-name"></span></h2>
            <p class="product_by"><span>by</span><span><a href="/shop/goods/goods_list.php?category=&search_word=&search_by_brand%5B%5D=881">K9 Natural</a></span></p>
            <div class="star">
                            <span class="ic-star">
                                <!-- 별점 width 값 입력 -->
                                <em style="width:80%">80점</em>
                            </span>
                <em class="review-lnk"><a href="/shop/goods/goods_post.php?goodsno=45932"><em class="en">46</em>명 구매후기</a><span class="bar">|</span><a href="/shop/goods/goods_qna_list.php?goodsno=45932"><em class="en">0</em>개 질문/답변</a></em>
            </div>
        </div>
        <div class="cont">
            ...
            <div class="price_info">
                ...
                <table>
                    ...
                    <tr>
                        <th>판매가:</th>
                        <td class="price_view"><del>5,000<span class="won">원</span></del></td>
                    </tr>
                    <tr class="price discount ">
                        <th>할인가:</th>
                        <td>
                            <span class="opt_price red" style="display: inline-block;"></span><span class="discount-price red" style="display: inline-block;">4,500<span class="red">원</span></span> <span class="red" id="apopprice" style="display: inline-block;"></span>

                        </td>
                    </tr>
                    <tr class="price discounted">
                        <th>할인받은 금액:</th>
                        <td><span class="red"><span class="discounted-price">500</span><span class="red won">원</span>  (<span class="discount-rate">10</span>%)</span></td>
                    </tr>
...
-->
                    ...
                    <dd class="delivery-time"  >
                        <span id="remain_time"><strong>5시간 49분</strong> 이내에 주문시 <strong><strong>오늘</strong></strong> 발송</span>
                    </dd>
            ...
            <ul class="prdc" style="margin-top: 4px;">
                <li>뉴질랜드 자연방목한 신선한 고기를 주재료로 사용</li>
                <li>항생제나 호르몬제를 사용하지 않은 휴먼그레이드 고기</li>
                <li>인공첨가제, 방부제, 또는 글루텐 성분 제외</li>
                <li>겔화제가 아닌 신선한 물을 사용하여 음수량 증가에 도움</li>
            </ul>
...
<div class="detail-cont">
    ...
    <div style="text-align: center; margin-left: -10%"><button class="btn btn-primary" type="button">구매하기</button></div>
