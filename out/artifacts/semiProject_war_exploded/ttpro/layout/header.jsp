        ...
        <div class="menubar">
             <div class="row" style="margin: 0 0 30px 65px">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<%=baseurl%>/catboard/catList.jsp?cpage=1" id="parcel">분양</a>
                        <ul>
                            <li><a class="nav-link" href="<%=baseurl%>/catboard/catList.jsp?cpage=1">Cat's</a></li>
