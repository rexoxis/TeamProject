...
<div class="container">
    ...
    <div class="main">
        ...
        <form name="frmJoin" action="joinMember.do" onSubmit="return CheckForm(this)">
        ...
        ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다. </textarea>
                ...
                <div class="custom-cuntrol custom-checkbox text-right">
                    ...
                    <label for="agree2" class="custom-control-label" style="margin-top: 20px">개인정보 수집 및 이용에
                        동의합니다</label>
                </div>
            </div>
            <div class="text-center" style="margin: 15px 0">
                <button class="btn btn-success" type="submit" id="agreebtn">모두 동의합니다.</button>
                <button class="btn btn-danger" type="button" id="notagree" onclick="javascript:history.back();">동의하지
                    않습니다.
                </button>
            </div>
        </form>
